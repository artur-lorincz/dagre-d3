...
function render() {
  ...
  var fn = function(svg, g) {
    ...
    console.log('positioning clusters...');

    var clusters = createClusters(clustersGroup, g);
    positionClusters(clusters, g);
    console.log('positioning clusters done...');

    console.log('postprocessing graph...');
